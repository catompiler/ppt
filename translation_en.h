...
TEXT_TR(TR_ID_UNITS_SPEED_PID_P, "A/V")
TEXT_TR(TR_ID_UNITS_SPEED_PID_I, "A/(V*ms)")
TEXT_TR(TR_ID_UNITS_SPEED_PID_D, "A/V*ms")
TEXT_TR(TR_ID_UNITS_SPEED_PID_P, "A/V")
TEXT_TR(TR_ID_UNITS_SPEED_PID_I, "A/(V*ms)")
TEXT_TR(TR_ID_UNITS_SPEED_PID_D, "A/V*ms")
TEXT_TR(TR_ID_UNITS_CURRENT_PID_P, "°/A")
TEXT_TR(TR_ID_UNITS_CURRENT_PID_I, "°/(A*ms)")
TEXT_TR(TR_ID_UNITS_CURRENT_PID_D, "°/A*ms")
TEXT_TR(TR_ID_UNITS_EXC_CURRENT_PID_P, "°/A")
TEXT_TR(TR_ID_UNITS_EXC_CURRENT_PID_I, "°/(A*ms)")
TEXT_TR(TR_ID_UNITS_EXC_CURRENT_PID_D, "°/A*ms")
