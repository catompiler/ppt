...
TEXT_TR(TR_ID_UNITS_MIN, "m")
TEXT_TR(TR_ID_UNITS_PERCENT, "%")
TEXT_TR(TR_ID_UNITS_DEGREE, "°")
TEXT_TR(TR_ID_UNITS_DEGREE_CELSIUS, "°C")
TEXT_TR(TR_ID_UNITS_SPEED_PID_P, "A/rpm")
TEXT_TR(TR_ID_UNITS_SPEED_PID_I, "A/(rpm*s)")
TEXT_TR(TR_ID_UNITS_SPEED_PID_D, "A/rpm*s")
TEXT_TR(TR_ID_UNITS_CURRENT_PID_P, "°/A")
TEXT_TR(TR_ID_UNITS_CURRENT_PID_I, "°/(A*s)")
TEXT_TR(TR_ID_UNITS_CURRENT_PID_D, "°/A*s")
TEXT_TR(TR_ID_UNITS_EXC_CURRENT_PID_P, "°/A")
TEXT_TR(TR_ID_UNITS_EXC_CURRENT_PID_I, "°/(A*s)")
TEXT_TR(TR_ID_UNITS_EXC_CURRENT_PID_D, "°/A*s")
