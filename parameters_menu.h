...
SUBMENU(m_item1, 0, NULL, &m_item2, NULL, &m_item9, TEXT(TR_ID_MENU_COMMANDS), NULL, 0, 0, 0);
	...
	MENU_ITEM(m_item6, CMD_ID_CLEAR_EVENTS, &m_item1, NULL, &m_item5, &m_item7, TEXT(TR_ID_MENU_CMD_CLEAR_EVENTS), NULL, 0, 0, MENU_FLAG_CMD, 0);
	...
	MENU_ITEM(m_item8, CMD_ID_TEST_LEDS, &m_item1, NULL, &m_item7, NULL, TEXT(TR_ID_MENU_CMD_TEST_LEDS), NULL, 0, 0, MENU_FLAG_CMD, 0);
