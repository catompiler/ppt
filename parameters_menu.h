...
MENU_VALUES(menu_enum_gui_tiles,
    ...
    MAKE_MENU_VALUE_STRING(TEXT(TR_ID_ENUM_TILES_DRIVE_POWER_U_ROT_WIRES)),    // PARAM_ID_POWER_U_ROT    
...
SUBMENU(m_item135, 0, NULL, &m_item136, &m_item132, &m_item145, TEXT(TR_ID_MENU_MOTOR), NULL, 0, 0, 0);
	...
	MENU_ITEM(m_item144, PARAM_ID_MOTOR_R_ROT_NOM, &m_item135, NULL, &m_item143, &m_item144_1, TEXT(TR_ID_MENU_MOTOR_R_ROT_NOM), NULL, 0, 0, MENU_FLAG_DATA, 0);
	MENU_ITEM(m_item144_1, PARAM_ID_MOTOR_R_EXC_NOM, &m_item135, NULL, &m_item144, &m_item144_2, TEXT(TR_ID_MENU_MOTOR_R_EXC_NOM), NULL, 0, 0, MENU_FLAG_DATA, 0);
        MENU_ITEM(m_item144_2, PARAM_ID_MOTOR_I_ROT_MAX, &m_item135, NULL, &m_item144_1, &m_item144_3, TEXT(TR_ID_MENU_MOTOR_I_ROT_MAX), NULL, 0, 0, MENU_FLAG_DATA, 0);
        MENU_ITEM(m_item144_3, PARAM_ID_MOTOR_R_WIRES, &m_item135, NULL, &m_item144_2, NULL, TEXT(TR_ID_MENU_MOTOR_R_WIRES), NULL, 0, 0, MENU_FLAG_DATA, 0);        
...
SUBMENU(m_item193, 0, NULL, &m_item194, &m_item182, &m_item405, TEXT(TR_ID_MENU_PROTECTION), NULL, 0, 0, 0);
	SUBMENU(m_item194, 0, &m_item193, &m_item195, NULL, &m_item198, TEXT(TR_ID_MENU_THERMAL_OVERLOAD_PROT), NULL, 0, 0, 0);
		...
		MENU_ITEM(m_item196, PARAM_ID_THERMAL_OVERLOAD_PROT_TIME_2I, &m_item194, NULL, &m_item195, &m_item197, TEXT(TR_ID_MENU_THERMAL_OVERLOAD_PROT_TIME_2I), NULL, 0, 0, MENU_FLAG_DATA, 0);
...
MENU_DESCRS(menu_descrs) {
    ...
    MENU_DESCR(0, 0, TEXT(TR_ID_MENU_PROTECTION), NULL, 0, 0, 0, 0),
        ...
        MENU_DESCR(1, 0, TEXT(TR_ID_MENU_THERMAL_OVERLOAD_PROT), NULL, 0, 0, 0, 0),
            ...
            MENU_DESCR(2, PARAM_ID_THERMAL_OVERLOAD_PROT_TIME_6I, TEXT(TR_ID_MENU_THERMAL_OVERLOAD_PROT_TIME_2I), NULL, 0, MENU_FLAG_DATA, 0, 0),
