...
MENU_DESCRS(menu_descrs) {
    // Питание.
    MENU_DESCR(0, 0, TEXT(TR_ID_MENU_POWER), NULL, 0, 0, 0, 0),
        // Сеть.
        MENU_DESCR(1, 0, TEXT(TR_ID_MENU_POWER_IN), NULL, 0, 0, 0, 0),
            MENU_DESCR(2, PARAM_ID_U_NOM, TEXT(TR_ID_MENU_U_NOM), NULL, 0, MENU_FLAG_DATA, 0, 0),
            MENU_DESCR(2, PARAM_ID_I_NOM, TEXT(TR_ID_MENU_I_NOM), NULL, 0, MENU_FLAG_DATA, 0, 0),
        // Якорь.
        MENU_DESCR(1, 0, TEXT(TR_ID_MENU_ROTOR), NULL, 0, 0, 0, 0),
            MENU_DESCR(2, PARAM_ID_U_ROT_NOM, TEXT(TR_ID_MENU_U_ROT_NOM), NULL, 0, MENU_FLAG_DATA, 0, 0),
            MENU_DESCR(2, PARAM_ID_I_ROT_NOM, TEXT(TR_ID_MENU_I_ROT_NOM), NULL, 0, MENU_FLAG_DATA, 0, 0),
        // Возбуждение.
