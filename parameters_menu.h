...
MENU_DESCRS(menu_descrs) {
    ...
    MENU_DESCR(0, 0, TEXT(TR_ID_MENU_ADC_VALUE_MULTS), NULL, 0, 0, 0, 0),
        MENU_DESCR(1, PARAM_ID_VALUE_MULTIPLIER_Ua, TEXT(TR_ID_MENU_ADC_VALUE_MULT_Ua), NULL, 0, MENU_FLAG_DATA, 0, 0),
        MENU_DESCR(1, PARAM_ID_VALUE_MULTIPLIER_Ub, TEXT(TR_ID_MENU_ADC_VALUE_MULT_Ub), NULL, 0, MENU_FLAG_DATA, 0, 0),
        MENU_DESCR(1, PARAM_ID_VALUE_MULTIPLIER_Uc, TEXT(TR_ID_MENU_ADC_VALUE_MULT_Uc), NULL, 0, MENU_FLAG_DATA, 0, 0),
        MENU_DESCR(1, PARAM_ID_VALUE_MULTIPLIER_Urot, TEXT(TR_ID_MENU_ADC_VALUE_MULT_Urot), NULL, 0, MENU_FLAG_DATA, 0, 0),
        MENU_DESCR(1, PARAM_ID_VALUE_MULTIPLIER_Ia, TEXT(TR_ID_MENU_ADC_VALUE_MULT_Ia), NULL, 0, MENU_FLAG_DATA, 0, 0),
        MENU_DESCR(1, PARAM_ID_VALUE_MULTIPLIER_Ib, TEXT(TR_ID_MENU_ADC_VALUE_MULT_Ib), NULL, 0, MENU_FLAG_DATA, 0, 0),
        MENU_DESCR(1, PARAM_ID_VALUE_MULTIPLIER_Ic, TEXT(TR_ID_MENU_ADC_VALUE_MULT_Ic), NULL, 0, MENU_FLAG_DATA, 0, 0),
        MENU_DESCR(1, PARAM_ID_VALUE_MULTIPLIER_Irot, TEXT(TR_ID_MENU_ADC_VALUE_MULT_Irot), NULL, 0, MENU_FLAG_DATA, 0, 0),
        MENU_DESCR(1, PARAM_ID_VALUE_MULTIPLIER_Iexc, TEXT(TR_ID_MENU_ADC_VALUE_MULT_Iexc), NULL, 0, MENU_FLAG_DATA, 0, 0),
        MENU_DESCR(1, PARAM_ID_VALUE_MULTIPLIER_Iref, TEXT(TR_ID_MENU_ADC_VALUE_MULT_Iref), NULL, 0, MENU_FLAG_DATA, 0, 0),
        MENU_DESCR(1, PARAM_ID_VALUE_MULTIPLIER_Ifan, TEXT(TR_ID_MENU_ADC_VALUE_MULT_Ifan), NULL, 0, MENU_FLAG_DATA, 0, 0),
    // Калибровочные данные.
    MENU_DESCR(0, 0, TEXT(TR_ID_MENU_CALIBRATION_DATA), NULL, 0, 0, 0, 0),
        MENU_DESCR(1, PARAM_ID_CALIBRATION_DATA_Ua, TEXT(TR_ID_MENU_CALIBRATION_DATA_Ua), NULL, 0, MENU_FLAG_DATA, 0, 0),
        MENU_DESCR(1, PARAM_ID_CALIBRATION_DATA_Ub, TEXT(TR_ID_MENU_CALIBRATION_DATA_Ub), NULL, 0, MENU_FLAG_DATA, 0, 0),
        MENU_DESCR(1, PARAM_ID_CALIBRATION_DATA_Uc, TEXT(TR_ID_MENU_CALIBRATION_DATA_Uc), NULL, 0, MENU_FLAG_DATA, 0, 0),
        MENU_DESCR(1, PARAM_ID_CALIBRATION_DATA_Urot, TEXT(TR_ID_MENU_CALIBRATION_DATA_Urot), NULL, 0, MENU_FLAG_DATA, 0, 0),
        MENU_DESCR(1, PARAM_ID_CALIBRATION_DATA_Ia, TEXT(TR_ID_MENU_CALIBRATION_DATA_Ia), NULL, 0, MENU_FLAG_DATA, 0, 0),
        MENU_DESCR(1, PARAM_ID_CALIBRATION_DATA_Ib, TEXT(TR_ID_MENU_CALIBRATION_DATA_Ib), NULL, 0, MENU_FLAG_DATA, 0, 0),
        MENU_DESCR(1, PARAM_ID_CALIBRATION_DATA_Ic, TEXT(TR_ID_MENU_CALIBRATION_DATA_Ic), NULL, 0, MENU_FLAG_DATA, 0, 0),
        MENU_DESCR(1, PARAM_ID_CALIBRATION_DATA_Irot, TEXT(TR_ID_MENU_CALIBRATION_DATA_Irot), NULL, 0, MENU_FLAG_DATA, 0, 0),
        MENU_DESCR(1, PARAM_ID_CALIBRATION_DATA_Iexc, TEXT(TR_ID_MENU_CALIBRATION_DATA_Iexc), NULL, 0, MENU_FLAG_DATA, 0, 0),
        MENU_DESCR(1, PARAM_ID_CALIBRATION_DATA_Iref, TEXT(TR_ID_MENU_CALIBRATION_DATA_Iref), NULL, 0, MENU_FLAG_DATA, 0, 0),
        MENU_DESCR(1, PARAM_ID_CALIBRATION_DATA_Ifan, TEXT(TR_ID_MENU_CALIBRATION_DATA_Ifan), NULL, 0, MENU_FLAG_DATA, 0, 0),
