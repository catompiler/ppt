...
GUI_TILE_TYPES(gui_tile_types, GUI_TILE_TYPES_COUNT) {
    ...
    GUI_TILE_TYPE(PARAM_ID_POWER_U_ROT_WIRES, TEXT(TR_ID_HOME_U_ROT_WIRES), PARAM_ID_POWER_U_ROT_ALARM_MIN, PARAM_ID_POWER_U_ROT_WARN_MIN, PARAM_ID_POWER_U_ROT_WARN_MAX, PARAM_ID_POWER_U_ROT_ALARM_MAX, NULL),
