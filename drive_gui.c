...
GUI_TILE_TYPES(gui_tile_types, GUI_TILE_TYPES_COUNT) {
    ...
    GUI_TILE_TYPE(PARAM_ID_POWER_U_B, TEXT(TR_ID_HOME_PHASE_B_VOLTAGE), PARAM_ID_POWER_U_ALARM_MIN, PARAM_ID_POWER_U_WARN_MIN, PARAM_ID_POWER_U_WARN_MAX, PARAM_ID_POWER_U_ALARM_MAX),
    GUI_TILE_TYPE(PARAM_ID_POWER_U_C, TEXT(TR_ID_HOME_PHASE_C_VOLTAGE), PARAM_ID_POWER_U_ALARM_MIN, PARAM_ID_POWER_U_WARN_MIN, PARAM_ID_POWER_U_WARN_MAX, PARAM_ID_POWER_U_ALARM_MAX),
    GUI_TILE_TYPE(PARAM_ID_POWER_U_ROT, TEXT(TR_ID_HOME_ANCHOR_VOLTAGE), PARAM_ID_POWER_U_ROT_ALARM_MIN, PARAM_ID_POWER_U_ROT_WARN_MIN, PARAM_ID_POWER_U_ROT_WARN_MAX, PARAM_ID_POWER_U_ROT_ALARM_MAX),
    GUI_TILE_TYPE(PARAM_ID_POWER_I_A, TEXT(TR_ID_HOME_PHASE_A_CURRENT), PARAM_ID_POWER_I_ALARM_MIN, PARAM_ID_POWER_I_WARN_MIN, PARAM_ID_POWER_I_WARN_MAX, PARAM_ID_POWER_I_ALARM_MAX),
    GUI_TILE_TYPE(PARAM_ID_POWER_I_B, TEXT(TR_ID_HOME_PHASE_B_CURRENT), PARAM_ID_POWER_I_ALARM_MIN, PARAM_ID_POWER_I_WARN_MIN, PARAM_ID_POWER_I_WARN_MAX, PARAM_ID_POWER_I_ALARM_MAX),
    GUI_TILE_TYPE(PARAM_ID_POWER_I_C, TEXT(TR_ID_HOME_PHASE_C_CURRENT), PARAM_ID_POWER_I_ALARM_MIN, PARAM_ID_POWER_I_WARN_MIN, PARAM_ID_POWER_I_WARN_MAX, PARAM_ID_POWER_I_ALARM_MAX),
    GUI_TILE_TYPE(PARAM_ID_POWER_I_ROT, TEXT(TR_ID_HOME_ANCHOR_CURRENT), PARAM_ID_POWER_I_ROT_ALARM_MIN, PARAM_ID_POWER_I_ROT_WARN_MIN, PARAM_ID_POWER_I_ROT_WARN_MAX, PARAM_ID_POWER_I_ROT_ALARM_MAX),
    GUI_TILE_TYPE(PARAM_ID_POWER_I_EXC, TEXT(TR_ID_HOME_EXCITATION_CURRENT), PARAM_ID_POWER_I_EXC_ALARM_MIN, PARAM_ID_POWER_I_EXC_WARN_MIN, PARAM_ID_POWER_I_EXC_WARN_MAX, PARAM_ID_POWER_I_EXC_ALARM_MAX),
            
    GUI_TILE_TYPE(PARAM_ID_POWER_I_FAN, TEXT(TR_ID_HOME_POWER_I_FAN), PARAM_ID_POWER_I_FAN_ALARM_MIN, PARAM_ID_POWER_I_FAN_WARN_MIN, PARAM_ID_POWER_I_FAN_WARN_MAX, PARAM_ID_POWER_I_FAN_ALARM_MAX),
    GUI_TILE_TYPE(PARAM_ID_POWER_I_REF, TEXT(TR_ID_HOME_POWER_I_REF), PARAM_ID_POWER_I_REF_ALARM_MIN, PARAM_ID_POWER_I_REF_WARN_MIN, PARAM_ID_POWER_I_REF_WARN_MAX, PARAM_ID_POWER_I_REF_ALARM_MAX),
      
    GUI_TILE_TYPE(PARAM_ID_HEATSINK_TEMP, TEXT(TR_ID_HOME_HEATSINK_TEMP), PARAM_ID_HEATSINK_TEMP_ALARM_MIN, PARAM_ID_HEATSINK_TEMP_WARN_MIN, PARAM_ID_HEATSINK_TEMP_WARN_MAX, PARAM_ID_HEATSINK_TEMP_ALARM_MAX),
    
    GUI_TILE_TYPE(PARAM_ID_HEATSINK_FAN_RPM, TEXT(TR_ID_HOME_HEATSINK_FAN_RPM), PARAM_ID_HEATSINK_FAN_RPM_ALARM_MIN, PARAM_ID_HEATSINK_FAN_RPM_WARN_MIN, PARAM_ID_HEATSINK_FAN_RPM_WARN_MAX, PARAM_ID_HEATSINK_FAN_RPM_ALARM_MAX),   
    GUI_TILE_TYPE(PARAM_ID_TRIACS_PAIRS_OPEN_ANGLE, TEXT(TR_ID_HOME_TRIACS_PAIRS_OPEN_ANGLE), PARAM_ID_TRIACS_PAIRS_OPEN_ANGLE_ALARM_MIN, PARAM_ID_TRIACS_PAIRS_OPEN_ANGLE_WARN_MIN, PARAM_ID_TRIACS_PAIRS_OPEN_ANGLE_WARN_MAX, PARAM_ID_TRIACS_PAIRS_OPEN_ANGLE_ALARM_MAX),   
    GUI_TILE_TYPE(PARAM_ID_TRIAC_EXC_OPEN_ANGLE, TEXT(TR_ID_HOME_TRIAC_EXC_OPEN_ANGLE), PARAM_ID_TRIAC_EXC_OPEN_ANGLE_ALARM_MIN, PARAM_ID_TRIAC_EXC_OPEN_ANGLE_WARN_MIN, PARAM_ID_TRIAC_EXC_OPEN_ANGLE_WARN_MAX, PARAM_ID_TRIAC_EXC_OPEN_ANGLE_ALARM_MAX),   
