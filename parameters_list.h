...
#define PARAMETERS_REAL_COUNT 393
// Число виртуальных параметров.
#define PARAMETERS_VIRT_COUNT 50
...
PARAM_DESCRS(parameters_descrs, PARAMETERS_COUNT) {
    ...
    PARAM_DESCR(PARAM_ID_PHASE_SYNC_PLL_PID_K_P, PARAM_TYPE_FRACT_1000, F32I(0), F32I(100), F32(12, 1),    0, NOUNITS), // Kp.
    PARAM_DESCR(PARAM_ID_PHASE_SYNC_PLL_PID_K_I, PARAM_TYPE_FRACT_1000, F32I(0), F32I(100), F32(12, 1000), 0, NOUNITS), // Ki.
    PARAM_DESCR(PARAM_ID_PHASE_SYNC_PLL_PID_K_D, PARAM_TYPE_FRACT_1000, F32I(0), F32I(100), F32I(0),       0, NOUNITS), // Kd.
    ...
    PARAM_DESCR(PARAM_ID_ROT_PID_K_P,     PARAM_TYPE_FRACT_1000, F32I(0), F32I(32), F32(5, 10),   0, TEXT(TR_ID_UNITS_CURRENT_PID_P)), // Kp.
    PARAM_DESCR(PARAM_ID_ROT_PID_K_I,     PARAM_TYPE_FRACT_1000, F32I(0), F32I(32), F32(1, 10),   0, TEXT(TR_ID_UNITS_CURRENT_PID_I)), // Ki.
    PARAM_DESCR(PARAM_ID_ROT_PID_K_D,     PARAM_TYPE_FRACT_1000, F32I(0), F32I(32), F32I(0),      0, TEXT(TR_ID_UNITS_CURRENT_PID_D)), // Kd.
    PARAM_DESCR(PARAM_ID_EXC_PID_K_P,     PARAM_TYPE_FRACT_100, F32I(0), F32I(320), F32(10, 1),   0, TEXT(TR_ID_UNITS_EXC_CURRENT_PID_P)), // Kp.
    PARAM_DESCR(PARAM_ID_EXC_PID_K_I,     PARAM_TYPE_FRACT_100, F32I(0), F32I(320), F32(1, 1),    0, TEXT(TR_ID_UNITS_EXC_CURRENT_PID_I)), // Ki.
    PARAM_DESCR(PARAM_ID_EXC_PID_K_D,     PARAM_TYPE_FRACT_100, F32I(0), F32I(320), F32I(0),      0, TEXT(TR_ID_UNITS_EXC_CURRENT_PID_D)), // Kd.
    ...
    PARAM_DESCR(PARAM_ID_POWER_U_ROT_WIRES,PARAM_TYPE_FRACT_10, 0, 0, 0, PARAM_FLAG_VIRTUAL, TEXT(TR_ID_UNITS_V)),
