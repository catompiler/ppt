...
#define PARAMETERS_REAL_COUNT 377
...
PARAM_DESCRS(parameters_descrs, PARAMETERS_COUNT) {
    ...
    PARAM_DESCR(PARAM_ID_MOTOR_I_ROT_NOM,  PARAM_TYPE_FRACT_10,  F32I(0),   F32I(200),  F32I(50), 0, TEXT(TR_ID_UNITS_A)),
    ...
    PARAM_DESCR(PARAM_ID_PROT_SENSORS_U_IN_WARN_ACTION,       PARAM_TYPE_UINT, 0,    4,    1, 0, NOUNITS),
    PARAM_DESCR(PARAM_ID_PROT_SENSORS_U_IN_FAULT_ACTION,      PARAM_TYPE_UINT, 0,    4,    4, 0, NOUNITS),
    // Ток сети.
    ...
    PARAM_DESCR(PARAM_ID_PROT_SENSORS_I_IN_WARN_ACTION,       PARAM_TYPE_UINT, 0,    4,    1, 0, NOUNITS),
    PARAM_DESCR(PARAM_ID_PROT_SENSORS_I_IN_FAULT_ACTION,      PARAM_TYPE_UINT, 0,    4,    4, 0, NOUNITS),
    // Напряжение якоря.
    ...
    PARAM_DESCR(PARAM_ID_PROT_SENSORS_U_ROT_WARN_ACTION,       PARAM_TYPE_UINT, 0,    4,    1, 0, NOUNITS),
    PARAM_DESCR(PARAM_ID_PROT_SENSORS_U_ROT_FAULT_ACTION,      PARAM_TYPE_UINT, 0,    4,    4, 0, NOUNITS),
    // Ток якоря.
    ...
    PARAM_DESCR(PARAM_ID_PROT_SENSORS_I_ROT_WARN_ACTION,       PARAM_TYPE_UINT, 0,    4,    1, 0, NOUNITS),
    PARAM_DESCR(PARAM_ID_PROT_SENSORS_I_ROT_FAULT_ACTION,      PARAM_TYPE_UINT, 0,    4,    4, 0, NOUNITS),
    // Ток возбуждения.
    ...
    PARAM_DESCR(PARAM_ID_PROT_SENSORS_I_EXC_WARN_ACTION,       PARAM_TYPE_UINT, 0,    4,    1, 0, NOUNITS),
    PARAM_DESCR(PARAM_ID_PROT_SENSORS_I_EXC_FAULT_ACTION,      PARAM_TYPE_UINT, 0,    4,    4, 0, NOUNITS),
