...
#define PARAMETERS_REAL_COUNT 275
// Число виртуальных параметров.
#define PARAMETERS_VIRT_COUNT 20
...
PARAM_DESCRS(parameters_descrs, PARAMETERS_COUNT) {
    ...
    PARAM_DESCR(PARAM_ID_MODBUS_ADDRESS,  PARAM_TYPE_UINT,     1,    255,   170,  0, NOUNITS),
    ...
    // Ток фазы.
    PARAM_DESCR(PARAM_ID_POWER_I_ALARM_MIN,   PARAM_TYPE_FRACT_100, F32I(0), F32I(1000), F32I(50), 0, TEXT(TR_ID_UNITS_A)),
    PARAM_DESCR(PARAM_ID_POWER_I_WARN_MIN,   PARAM_TYPE_FRACT_100, F32I(0), F32I(1000), F32I(75), 0, TEXT(TR_ID_UNITS_A)),
    PARAM_DESCR(PARAM_ID_POWER_I_WARN_MAX,   PARAM_TYPE_FRACT_100, F32I(0), F32I(1000), F32I(125), 0, TEXT(TR_ID_UNITS_A)),
    PARAM_DESCR(PARAM_ID_POWER_I_ALARM_MAX,   PARAM_TYPE_FRACT_100, F32I(0), F32I(1000), F32I(150), 0, TEXT(TR_ID_UNITS_A)),
    // Ток якоря.
    ...
    // Ток возбуждения.
    PARAM_DESCR(PARAM_ID_POWER_I_EXC_ALARM_MIN, PARAM_TYPE_FRACT_1000, F32I(0), F32I(1000), F32I(50), 0, TEXT(TR_ID_UNITS_A)),
    PARAM_DESCR(PARAM_ID_POWER_I_EXC_WARN_MIN, PARAM_TYPE_FRACT_1000, F32I(0), F32I(1000), F32I(75), 0, TEXT(TR_ID_UNITS_A)),
    PARAM_DESCR(PARAM_ID_POWER_I_EXC_WARN_MAX, PARAM_TYPE_FRACT_1000, F32I(0), F32I(1000), F32I(125), 0, TEXT(TR_ID_UNITS_A)),
    PARAM_DESCR(PARAM_ID_POWER_I_EXC_ALARM_MAX, PARAM_TYPE_FRACT_1000, F32I(0), F32I(1000), F32I(150), 0, TEXT(TR_ID_UNITS_A)),
    // Температура радиатора.
