...
#define PARAMETERS_REAL_COUNT 314
...
PARAM_DESCRS(parameters_descrs, PARAMETERS_COUNT) {
    ...
    PARAM_DESCR(PARAM_ID_MOTOR_EFF_NOM,    PARAM_TYPE_FRACT_10,  F32I(40),  F32I(99),   F32I(95), 0, TEXT(TR_ID_UNITS_PERCENT)),
    PARAM_DESCR(PARAM_ID_MOTOR_R_ROT_NOM,  PARAM_TYPE_FRACT_100, F32I(0),   F32I(20),   F32(5,10),0, TEXT(TR_ID_UNITS_OHM)),
    ...
    PARAM_DESCR(PARAM_ID_MOTOR_RPM,    PARAM_TYPE_UINT,      0, 0, 0, PARAM_FLAG_VIRTUAL, TEXT(TR_ID_UNITS_RPM)),
