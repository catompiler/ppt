...
#define PARAMETERS_REAL_COUNT 421
...
PARAM_DESCRS(parameters_descrs, PARAMETERS_COUNT) {
    ...
    PARAM_DESCR(PARAM_ID_SELFTUNE_OPEN_ANGLE,      PARAM_TYPE_UINT,   10,  50, 10, 0, TEXT(TR_ID_UNITS_DEGREE)),
    PARAM_DESCR(PARAM_ID_SELFTUNE_USE_MID_FILTER,  PARAM_TYPE_UINT,    0,   1,  0, 0, NOUNITS),
    PARAM_DESCR(PARAM_ID_SELFTUNE_DIDT_AVG_COUNT,  PARAM_TYPE_UINT,    1,  10,  1, 0, NOUNITS),
    PARAM_DESCR(PARAM_ID_SELFTUNE_ITERS_COUNT,     PARAM_TYPE_UINT,    1, 100, 10, 0, NOUNITS),
    PARAM_DESCR(PARAM_ID_SELFTUNE_PAUSE_TIME_MS,   PARAM_TYPE_UINT,    0,1000,100, 0, TEXT(TR_ID_UNITS_MS)),
