...
PARAM_DESCRS(parameters_descrs, PARAMETERS_COUNT) {
    ...
    PARAM_DESCR(PARAM_ID_ROT_PID_K_P,     PARAM_TYPE_FRACT_100, F32I(0), F32I(100), F32(25, 100),   0), // Kp.
    PARAM_DESCR(PARAM_ID_ROT_PID_K_I,     PARAM_TYPE_FRACT_100, F32I(0), F32I(100), F32(125, 100),   0), // Ki.
