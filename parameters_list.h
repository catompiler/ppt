...
#define PARAMETERS_VIRT_COUNT 15
...
PARAM_DESCRS(parameters_descrs, PARAMETERS_COUNT) {
    ...
    PARAM_DESCR(PARAM_ID_DEBUG_2,         PARAM_TYPE_INT, 0, 0, 0, PARAM_FLAG_VIRTUAL),
    PARAM_DESCR(PARAM_ID_DEBUG_3,         PARAM_TYPE_INT, 0, 0, 0, PARAM_FLAG_VIRTUAL),
    PARAM_DESCR(PARAM_ID_DEBUG_4,         PARAM_TYPE_INT, 0, 0, 0, PARAM_FLAG_VIRTUAL),
    PARAM_DESCR(PARAM_ID_DEBUG_5,         PARAM_TYPE_INT, 0, 0, 0, PARAM_FLAG_VIRTUAL),
    PARAM_DESCR(PARAM_ID_DEBUG_6,         PARAM_TYPE_INT, 0, 0, 0, PARAM_FLAG_VIRTUAL),
    PARAM_DESCR(PARAM_ID_DEBUG_7,         PARAM_TYPE_INT, 0, 0, 0, PARAM_FLAG_VIRTUAL),
    PARAM_DESCR(PARAM_ID_DEBUG_8,         PARAM_TYPE_INT, 0, 0, 0, PARAM_FLAG_VIRTUAL),
    PARAM_DESCR(PARAM_ID_DEBUG_9,         PARAM_TYPE_INT, 0, 0, 0, PARAM_FLAG_VIRTUAL),
