...
PARAM_DESCRS(parameters_descrs, PARAMETERS_COUNT) {
    ...
    PARAM_DESCR(PARAM_ID_RAMP_START_TIME,     PARAM_TYPE_UINT, RAMP_TIME_MIN, RAMP_TIME_MAX, RAMP_START_TIME_DEFAULT,     0, TEXT(TR_ID_UNITS_S)),
    PARAM_DESCR(PARAM_ID_RAMP_STOP_TIME,      PARAM_TYPE_UINT, RAMP_TIME_MIN, RAMP_TIME_MAX, RAMP_STOP_TIME_DEFAULT,      0, TEXT(TR_ID_UNITS_S)),
    PARAM_DESCR(PARAM_ID_RAMP_FAST_STOP_TIME, PARAM_TYPE_UINT, RAMP_TIME_MIN, RAMP_TIME_MAX, RAMP_FAST_STOP_TIME_DEFAULT, 0, TEXT(TR_ID_UNITS_S)),
    PARAM_DESCR(PARAM_ID_RAMP_REFERENCE_TIME, PARAM_TYPE_UINT, RAMP_TIME_MIN, RAMP_TIME_MAX, RAMP_REFERENCE_TIME_DEFAULT, 0, TEXT(TR_ID_UNITS_S)),
