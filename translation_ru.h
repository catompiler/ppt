...
TEXT_TR(TR_ID_UNITS_SPEED_PID_P, "А/В")
TEXT_TR(TR_ID_UNITS_SPEED_PID_I, "А/(В*мс)")
TEXT_TR(TR_ID_UNITS_SPEED_PID_D, "А/В*мс")
TEXT_TR(TR_ID_UNITS_CURRENT_PID_P, "°/А")
TEXT_TR(TR_ID_UNITS_CURRENT_PID_I, "°/(А*мс)")
TEXT_TR(TR_ID_UNITS_CURRENT_PID_D, "°/А*мс")
TEXT_TR(TR_ID_UNITS_EXC_CURRENT_PID_P, "°/А")
TEXT_TR(TR_ID_UNITS_EXC_CURRENT_PID_I, "°/(А*мс)")
TEXT_TR(TR_ID_UNITS_EXC_CURRENT_PID_D, "°/А*мс")
