...
TEXT_TR(TR_ID_UNITS_MIN, "м")
TEXT_TR(TR_ID_UNITS_PERCENT, "%")
TEXT_TR(TR_ID_UNITS_DEGREE, "°")
TEXT_TR(TR_ID_UNITS_DEGREE_CELSIUS, "°C")
TEXT_TR(TR_ID_UNITS_RPM, "об/мин")  
TEXT_TR(TR_ID_UNITS_RPM_SHORT, "Ξ") // RPM
TEXT_TR(TR_ID_UNITS_SPEED_PID_P, "А/об.мин")
TEXT_TR(TR_ID_UNITS_SPEED_PID_I, "А/(об.мин*с)")
TEXT_TR(TR_ID_UNITS_SPEED_PID_D, "А/об.мин*с")
TEXT_TR(TR_ID_UNITS_CURRENT_PID_P, "°/А")
TEXT_TR(TR_ID_UNITS_CURRENT_PID_I, "°/(А*с)")
TEXT_TR(TR_ID_UNITS_CURRENT_PID_D, "°/А*с")
TEXT_TR(TR_ID_UNITS_EXC_CURRENT_PID_P, "°/А")
TEXT_TR(TR_ID_UNITS_EXC_CURRENT_PID_I, "°/(А*с)")
TEXT_TR(TR_ID_UNITS_EXC_CURRENT_PID_D, "°/А*с")
...
TEXT_TR(TR_ID_ENUM_TILES_MOTOR_E, "ЭДС двигателя")  
...
TEXT_TR(TR_ID_HOME_MOTOR_E, "ЭДС двигателя")        
