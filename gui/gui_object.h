...
struct _Gui_Object {
    ...
    gui_metro_t* gui; //!< Графический интерфейс.
};
 ...
 * @return Код ошибки.
 */
EXTERN err_t gui_object_init(gui_object_t* object, gui_metro_t* gui);
 ...
 * @return Код ошибки.
 */
EXTERN err_t gui_object_init_parent(gui_object_t* object, gui_metro_t* gui, gui_object_t* parent);
 ...
 */
ALWAYS_INLINE static gui_metro_t* gui_object_gui(gui_object_t* object)
{
    return object->gui;
}
