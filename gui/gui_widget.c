...
err_t gui_widget_init(gui_widget_t* widget, gui_metro_t* gui)
{
    return gui_widget_init_parent(widget, gui, NULL);
}

err_t gui_widget_init_parent(gui_widget_t* widget, gui_metro_t* gui, gui_widget_t* parent)
{
    RETURN_ERR_IF_FAIL(gui_object_init_parent(GUI_OBJECT(widget), gui, GUI_OBJECT(parent)));
    
    widget->repaint_enable = true;
    ...
    widget->back_color = gui_metro_theme(gui_object_gui(GUI_OBJECT(widget)))->color_back;
...
void gui_widget_set_repaint_enable(gui_widget_t* widget, bool enable)
{
    widget->repaint_enable = enable;
}
...
void gui_widget_on_repaint(gui_widget_t* widget, const rect_t* rect)
{
    ...
    //gui_metro_theme_t* theme = gui_metro_theme(gui_widget_gui(widget));
...
err_t gui_widget_begin_paint(gui_widget_t* widget, painter_t* painter, const rect_t* rect)
{
    ...
    RETURN_ERR_IF_FAIL(painter_init(painter, gui_metro_graphics(gui_object_gui(GUI_OBJECT(widget)))));
