...
#define GUI_TILE_CONDITIONS_COUNT 19
GUI_TILE_CONDITIONS(gui_tile_conditions, GUI_TILE_CONDITIONS_COUNT) {
    ...
    GUI_TILE_CONDITION(drive_error, DRIVE_ERROR_ROT_MEASURE_BREAK, TEXT(TR_ID_DRIVE_ERROR_ROT_MEASURE_BREAK)), 
    GUI_TILE_CONDITION(drive_error, DRIVE_ERROR_SENSOR, TEXT(TR_ID_DRIVE_ERROR_SENSOR)),
    // предупреждения
    ...
    GUI_TILE_CONDITION(drive_warning, DRIVE_WARNING_SENSOR, TEXT(TR_ID_DRIVE_WARNING_SENSOR)),
    GUI_TILE_CONDITION(drive_warning, DRIVE_WARNING_TRIAC, TEXT(TR_ID_DRIVE_WARNING_TRIAC)) 
};
