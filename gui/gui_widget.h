...
struct _Gui_Widget {
    ...
    bool repaint_enable; //!< Флаг разрешения перерисовки.
    ...
    graphics_color_t front_color; //!< Цвет шрифта виджета.
    /**
 ...
 * @return Код ошибки.
 */
EXTERN err_t gui_widget_init(gui_widget_t* widget, gui_metro_t* gui);
 ...
 * @return Код ошибки.
 */
EXTERN err_t gui_widget_init_parent(gui_widget_t* widget, gui_metro_t* gui, gui_widget_t* parent);
...
/**
 * Получает флаг разрешения перерисовки.
 * @param widget Виджет.
 * @return Флаг разрешения перерисовки.
 */
ALWAYS_INLINE static bool gui_widget_repaint_enable(gui_widget_t* widget)
{
    return widget->repaint_enable;
}
...
/**
 * Устанавливает флаг разрешения перерисовки.
 * @param widget Виджет.
 * @param Флаг разрешения перерисовки.
 */
EXTERN void gui_widget_set_repaint_enable(gui_widget_t* widget, bool repaint_enable);
...
{
    return false;//gui_is_focus_widget(gui_object_gui(GUI_OBJECT(widget)), widget);
}
 ...
 */
ALWAYS_INLINE static gui_metro_t* gui_widget_gui(gui_widget_t* widget)
{
