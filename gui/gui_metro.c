...
err_t gui_metro_init(gui_metro_t* gui, graphics_t* graphics, gui_metro_theme_t* theme)
{
...
err_t gui_metro_set_graphics(gui_metro_t* gui, graphics_t* graphics)
{
    if(graphics == NULL) return E_NULL_POINTER;
...
err_t gui_metro_set_theme(gui_metro_t* gui, gui_metro_theme_t* theme)
{
    if(theme == NULL) return E_NULL_POINTER;
...
err_t gui_metro_set_root_widget(gui_metro_t* gui, gui_widget_t* widget)
{
...
bool gui_focus_next_widget(gui_metro_t* gui)
{
...
bool gui_focus_prev_widget(gui_metro_t* gui)
{
    gui_widget_t* widget = gui->focus_widget;
    if(widget == NULL){
        widget = gui->root_widget;
...
gui_widget_t* gui_widget_from_point(gui_metro_t* gui, graphics_pos_t x, graphics_pos_t y)
{
    rect_t rect;
...
void gui_metro_repaint(gui_metro_t* gui, rect_t* rect)
{
...
void gui_metro_key_pressed(gui_metro_t* gui, keycode_t key)
{
...
void gui_metro_key_released(gui_metro_t* gui, keycode_t key)
{
    if(gui->focus_widget == NULL) return;
...
bool gui_metro_set_focus_widget(gui_metro_t* gui, gui_widget_t* widget)
{
