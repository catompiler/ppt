...
#define PARAMETERS_REAL_COUNT 22
...
PARAM_DESCRS(parameters_descrs, PARAMETERS_COUNT) {
    ...
    PARAM_DESCR(PARAM_ID_U_ZERO_NOISE,    PARAM_TYPE_FRACT_100, F32I(0), F32I(10),  F32I(10),     0), // 1.0 В.
    PARAM_DESCR(PARAM_ID_I_ZERO_NOISE,    PARAM_TYPE_FRACT_100, F32I(0), F32I(100), F32I(50),     0), // 10 А.
    ...
    PARAM_DESCR(PARAM_ID_I_EXC,           PARAM_TYPE_FRACT_10,  F32I(0), F32I(20),  F32(5,10),    0), // 10 А.
